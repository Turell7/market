...
export function TableItem({ item, titlsTable }) {
  ...
  return (
    <tr>
      ...
      {tableRow()}
      <th>
        <button type="button" className="btn btn-error btn-circle btn-sm bg-gray-200 p-0 border-0 inline-flex items-center justify-center text-gray-500 ml-4">
